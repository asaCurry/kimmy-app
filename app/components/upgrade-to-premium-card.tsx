...
export const UpgradeToPremiumCard: React.FC<UpgradeToPremiumCardProps> = ({
  ...
  const premiumFeatures = [
    ...
    },
    {
      ...
      description:
        "AI-powered suggestions to improve your household management",
    },
    {
      icon: <Target className="w-5 h-5 text-green-400" />,
      title: "Pattern Detection",
      description:
        "Automatically identify trends in health, activities, and growth",
    },
    {
    ...
    <Card className="bg-gradient-to-br from-amber-500/5 to-orange-500/10 border-amber-500/20 relative overflow-hidden">
      ...
      <CardHeader className="relative">
        ...
        <CardDescription className="text-slate-300 text-base">
          {reason ||
            "Get detailed analytics and smart recommendations for your household management."}
        </CardDescription>
      </CardHeader>
        ...
        {household && (
          <div className="pt-4 border-t border-slate-700/50">
            <p className="text-sm text-slate-400">
              ...
              to access premium analytics features.
            </p>
          </div>
        )}
      </CardContent>
