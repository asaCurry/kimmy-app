  ...
  if (householdMembers.length === 0) {
    return (
      <section className="space-y-6">
        <h2 className="text-xl font-semibold text-slate-200 mb-6">Household Overview</h2>
        <div className="text-center py-16 px-4">
          ...
          <h3 className="text-2xl font-semibold text-white mb-3">No Family Members Yet</h3>
