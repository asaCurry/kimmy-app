...
const getGradient = (category: string): string => {
  switch (category) {
    case "Health": return "from-emerald-500/20 to-blue-500/20";
    case "Activities": return "from-orange-500/20 to-red-500/20";
    case "Personal": return "from-purple-500/20 to-pink-500/20";
    default: return "from-slate-600/20 to-slate-700/20";
  }
};

export const CategoryCard: React.FC<CategoryCardProps> = ({ category, recordCount, onSelect }) => {
  const icon = (
