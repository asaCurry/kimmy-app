 ...
 */
export function validateAndSanitizeText(value: unknown, maxLength: number = 1000): string | undefined {
  if (value === null || value === undefined || value === "") {
    return undefined;
  }
...
export const ApiResponse = {
  ...
  notFound: (resource: string = "Resource") => 
    Response.json({ success: false, error: `${resource} not found` }, { status: 404 }),
 ...
 */
export function validateSession(session: any): { userId: number; currentHouseholdId: string } {
