...
import { convertFieldsToFormData, convertFormDataToFields } from "~/lib/utils/dynamic-fields/field-serialization";
...
export const useDynamicForm = (options: UseDynamicFormOptions) => {
  ...
  const { handleSubmit, formState: { errors, isValid }, setValue, watch, reset } = form;
  ...
  }, [fields, onSubmit, onValidationError, isSubmitting, reset, formDefaultValues]);
