...
import { PasswordResetService, generateResetEmailContent } from "~/lib/password-reset";
import { z } from "zod";
    ...
    switch (action) {
      case "request-reset": {
        try {
          ...
          const tokenData = await passwordResetService.createResetToken(validatedEmail);
